...
try:
    for atom1 in st[0]['A'].get_atoms():
        for atom2 in st[0]['E'].get_atoms():
    ...
    for atom1 in st.get_atoms():
        ...
        Total_Solvation += Solvation_Atom      
        print('----------------------------------------------------------------')
   
    print('Solvation Energy of chain',chain1.id,': ',Total_Solvation)
